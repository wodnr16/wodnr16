...
const aboutMe = {
  ...
  interests: ["웹 개발", "UI/UX", "오픈소스"],
  currentFocus: "React & TypeScript",
  funFact: "커피 없이는 코딩 못해요 ☕"
};
```
...
[![trophy](https://github-profile-trophy.vercel.app/?username=wodnr16&theme=tokyonight&no-frame=true&row=1&column=7)](https://github.com/ryo-ma/github-profile-trophy)
...
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:snd.wodnr@gmail.com)
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=6366F1&center=true&vCenter=true&width=435&lines=Always+learning+new+things!;Love+to+solve+problems;Let's+build+something+together!)](https://git.io/typing-svg)
